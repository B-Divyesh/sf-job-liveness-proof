...
- `frontend/public/assets/run-proof-social.jpg`: a 1200×630 editorial crop of the original diorama, created locally on 2026-09-05 for Open Graph and Twitter cards. It contains no text and does not add a new subject or license.
